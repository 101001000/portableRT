...
public:
    ...
    void initializeScene()
    {
      ...
      float* vertices = (float*) rtcSetNewGeometryBuffer(m_tri,
      ...
      unsigned* indices = (unsigned*) rtcSetNewGeometryBuffer(m_tri,
    ...
    bool intersect_tri(const std::array<float,9>& tri, const Ray& ray) {
          ...
          bool res = castRay(m_scene, ray.origin[0], ray.origin[1], ray.origin[2], ray.direction[0], ray.direction[1], ray.direction[2]);
